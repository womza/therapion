		...
		<div class="container wrap">
			<div class="inner">
				...
				<div id="icon-menu"></div>	
					<div id="logo">
							<a href="http://www.therapion.com/dk/" title="Velkommen til Therapion Consulting Danmark. Therapion.com - psykologhjælp og netterapi.">
								Therapion
								<span></span>
							</a>
					</div>
...
<div id="main-menu" class="widget">
	<div class="container wrap">
		<div class="inner">			
			<div id="main-nav" >
				<ul>
					<li><a href="http://www.therapion.com/dk/">Hjem</a></li>
					<li><a href="http://www.therapion.com/dk/booking.php">Online booking</a></li>
					<li><a href="http://www.therapion.com/dk/priser.php">Priser og betalinger</a></li>
					<li><a href="http://www.therapion.com/dk/ledige-stillinger.php">Ledige stillinger</a></li>

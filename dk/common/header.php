		...
		<div class="container wrap">
			<div class="inner">
				...
				<div id="icon-menu"></div>	
					<div id="logo">
							<a href="./" title="Velkommen til Therapion Consulting Danmark. Therapion.com - psykologhjælp og netterapi.">
								Therapion
								<span></span>
							</a>
					</div>
		...
		<div class="inner">			
			<div id="main-nav" >
				<ul>
					...
					<li><a href="./priser.php">Priser og betalinger</a></li>
					<li><a href="./ledige-stillinger.php">Ledige stillinger</a></li>

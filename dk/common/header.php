		...
		<div class="container wrap">
			<div class="inner">
				...
				<div id="icon-menu"></div>	
					<div id="logo">
							<a href="http://www.therapion.local/dk/" title="Velkommen til Therapion Consulting Danmark. Therapion.com - psykologhjælp og netterapi.">
								Therapion
								<span></span>
							</a>
					</div>
...
<div id="main-menu" class="widget">
	<div class="container wrap">
		<div class="inner">			
			<div id="main-nav" >
				<ul>
					<li><a href="http://www.therapion.local/dk/">Hjem</a></li>
					<li><a href="http://www.therapion.local/dk/booking.php">Online booking</a></li>
					<li><a href="http://www.therapion.local/dk/priser.php">Priser og betalinger</a></li>
					<li><a href="http://www.therapion.local/dk/ledige-stillinger.php">Ledige stillinger</a></li>
					<li class="last"><a href="#">Vælg sprog</a>
						<div>
						<ul>
							<li  class="first">

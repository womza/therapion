...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
	...
	?>
		<title>Consulta por videoconferencia </title> 
				...
				<div class="full-column">
					<div class="info">
						...
						<form method="POST" action="./sendvideoconference.php?id_psicologo=<?php echo $psicologo['id_psicologo'] ?>">
							...
							<h3>Consulta por videoconferencia</h3>     
							...
							<h3>
							2. Programa de videoconferencia
							</h3>

							<p>
							La consulta por videoconferencia puede realizarse con el programa de su elección. Las alternativas son: Skype, Facebook, VSee, etc. 
							</p>

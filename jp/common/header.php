		...
		<div class="container wrap">
			<div class="inner">
				...
				<div id="icon-menu"></div>	
					<div id="logo">
							<a href="./" title="Therapion.com Japan 日本 | オンラインカウンセリング">
								Therapion
								<span></span>
							</a>
					</div>
	...
	<div class="container wrap">
		<div class="inner">			
			<div id="main-nav" >
				<ul>
					<li><a href="./">ホーム</a></li>
					<li><a href="./japan-appointments.php">ご予約</a></li>
					<li><a href="./japan-fees.php">サービス料金</a></li>
                                        <li><a href="./japan-therapy-programs.php">プログラム</a></li>
					<li><a href="./japan-jobs.php">募集中</a></li>

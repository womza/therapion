		...
		<div class="container wrap">
			<div class="inner">
				...
				<div id="icon-menu"></div>	
					<div id="logo">
	<a href="./" title="Therapion Consulting - Hoþgeldiniz! Therapion.com - Online psikolojik danýþma.">
								Therapion
								<span></span>
							</a>
					</div>
		...
		<div class="inner">			
			<div id="main-nav" >
				<ul>
					...
					<li><a href="./ucretleri.php">Ücretleri</a></li> 	
				        <li><a href="./sikca-sorulan-sorular.php">Servisimiz Hakkýnda</a></li>
                                        <li><a href="./isilanlari.php">Ýþ Ýlanlarý</a></li>

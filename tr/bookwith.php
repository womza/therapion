				...
				<div class="full-column">
					...
					<p>
						...
						<div class="wrap-buttons">	
							...
							<a class="standardsButton" href="<?php echo get_credentials()['site_root']?>/tr/<?php echo $psicologo_name ?>/email">E-posta <br />danışmanlık</a> 
							<?php elseif ($metodo['titulo']=='chat'): ?>
							<a class="standardsButton" href="<?php echo get_credentials()['site_root']?>/tr/<?php echo $psicologo_name ?>/chat">Yazılı <br />danışmanlık</a> 
							<?php elseif ($metodo['titulo']=='phone'): ?>
							<a class="standardsButton wm" href="<?php echo get_credentials()['site_root']?>/tr/<?php echo $psicologo_name ?>/phone">Telefonla <br />danışmanlık</a> 
							<?php else: ?>
							<a class="standardsButton wm" href="<?php echo get_credentials()['site_root']?>/tr/<?php echo $psicologo_name ?>/videoconference">Görüntülü <br/>danışmanlık</a>

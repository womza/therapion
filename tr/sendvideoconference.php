...
elseif(!ereg("^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,3})$", $email)) {
	echo "<h3>Problema with the e-mail address</h3><p>Please return to the form.</p>";
}
else {
	mail($receiverMail,$psicologo['nombres_apellidos'].": TR: VIDEOCONFERENCE: $location",  $msgformat, "From: $name <$email>");

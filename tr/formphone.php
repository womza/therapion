...
<head><meta http-equiv="Content-Type" content="text/html; charset=iso-8859-9">
	...
	?>
	<title>Telefonla danışmanlık </title> 
				...
				<div class="full-column">
					<div class="info">
						...
						<form method="POST" action="./sendphone.php?id_psicologo=<?php echo $psicologo['id_psicologo'] ?>">
							...
							<h3>Telefonla danışmanlık</h3>     
						    
						 <p>
                                            Bu formu doldurarak telefonla danışmanlık için randevu alabilirsiniz. 
                                        	</p>
							...
							<p>
                Lütfen telefon numaranızı giriniz. Eğer yurt dışında yaşıyorsanız, lütfen ülke kodunu bildirmeyi unutmayın. 
                                                        </p>

		...
		<div class="container wrap">
			<div class="inner">
				...
				<div id="icon-menu"></div>	
					<div id="logo">
							<a href="./" title="Bem-vindo ao Therapion Consulting. Therapion.com - Atención psicológica e terapia na Internet.">
								Therapion
								<span></span>
							</a>
					</div>
		...
		<div class="inner">			
			<div id="main-nav" >
				<ul>
					...
					<li><a href="./custo.php">Preços</a></li>
					<li><a href="./servicos.php">Serviços</a></li>
					<li><a href="./empregos.php">Empregos</a></li>

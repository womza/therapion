...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
	...
	?>
		<title>Consulta por videoconferência</title> 
				...
				<div class="full-column">
					<div class="info">
						...
						<form method="POST" action="./sendvideoconference.php?id_psicologo=<?php echo $psicologo['id_psicologo'] ?>">
							...
							<h3>Consulta por videoconferência</h3>     
						    
							<p>
							Aqui você pode reservar uma consulta pela videoconferência comigo.
							</p>							
							<br /><br />
							...
							<h3>
							2. Programa de videoconferência
							</h3>
							<p>

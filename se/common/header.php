		...
		<div class="container wrap">
			<div class="inner">
				...
				<div id="icon-menu"></div>	
					<div id="logo">
							<a href="http://www.therapion.local/se/" title="Välkommen till Therapion Consulting. Therapion.com - internetterapi och psykologhjälp.">
								Therapion
								<span></span>
							</a>
					</div>
...
<div id="main-menu" class="widget">
	<div class="container wrap">
		<div class="inner">			
			<div id="main-nav" >
				<ul>
					<li><a href="http://www.therapion.local/se/">Hem</a></li>
					<li><a href="http://www.therapion.local/se/bokning.php">Boka konsultation</a></li>
					<li><a href="http://www.therapion.local/se/psykologservice.php">Tjänster</a></li>
					<li><a href="http://www.therapion.local/se/priser.php">Priser</a></li>
					<li><a href="http://www.therapion.local/se/lediga-jobb.php">Lediga jobb</a></li>

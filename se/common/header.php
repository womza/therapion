		...
		<div class="container wrap">
			<div class="inner">
				...
				<div id="icon-menu"></div>	
					<div id="logo">
							<a href="./" title="Välkommen till Therapion Consulting. Therapion.com - internetterapi och psykologhjälp.">
								Therapion
								<span></span>
							</a>
					</div>
	...
	<div class="container wrap">
		<div class="inner">			
			<div id="main-nav" >
				<ul>
					<li><a href="./">Hem</a></li>
					<li><a href="./bokning.php">Boka konsultation</a></li>
					<li><a href="./psykologservice.php">Tjänster</a></li>
					<li><a href="./priser.php">Priser</a></li>
					<li><a href="./lediga-jobb.php">Lediga jobb</a></li>

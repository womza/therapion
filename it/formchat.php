...
<head>
	...
	?>
	<title>Consulenza psicologica via chat</title> 
				...
				<div class="full-column">
					<div class="info">
						...
						<form method="POST" action="./sendchat.php?id_psicologo=<?php echo $psicologo['id_psicologo'] ?>">
							...
							<h3>Consulenza psicologica via chat</h3>     
							...
							<h3>
							2. Programma per chattare
							</h3>

							<p> 
                                                        Lei può scegliere il programma per chattare. Buone alternative: Skype, VSee, ecc.
                                                        </p>

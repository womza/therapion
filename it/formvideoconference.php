...
<head>
	...
	?>
		<title>Consulenza psicologica via videoconferenza</title> 
				...
				<div class="full-column">
					<div class="info">
						...
						<form method="POST" action="./sendvideoconference.php?id_psicologo=<?php echo $psicologo['id_psicologo'] ?>">
							...
							<h3>Consulenza psicologica via videoconferenza</h3>     
							...
							<h3>
							2. Programma per videoconferenza
							</h3>

							<p>
                                                        Lei può scegliere il programma per videoconferenza. Buone alternative: Skype, VSee, ecc.
                                                        </p>

		...
		<div class="container wrap">
			<div class="inner">
				...
				<div id="icon-menu"></div>	
					<div id="logo">
							<a href="http://www.therapion.com/no/" title="Velkommen til Therapion Consulting. Therapion.com - psykologhjelp og netterapi.">
								Therapion
								<span></span>
							</a>
					</div>
...
<div id="main-menu" class="widget">
	<div class="container wrap">
		<div class="inner">			
			<div id="main-nav" >
				<ul>
					<li><a href="http://www.therapion.com/no/">Hjem</a></li>
					<li><a href="http://www.therapion.com/no/booking.php">Book konsultasjon</a></li>
					<li><a href="http://www.therapion.com/no/priser.php">Priser</a></li>
					<li><a href="http://www.therapion.com/no/ledige-jobber.php">Ledige jobber</a></li>

					...
					<div class="info">
					 	...
					 	<div class="photo rgt">
							<img src="../assets/images/profiles/mike.jpg" height="150" width="100">
                                                ...
                                                <h1>
                                                 Michiel Van Dijkhuizen - Klinisch Psycholoog
                                                </h1>
						
  


						<form method="POST" action="./nlsendchatmike.php">
						
							<h3>Sessie via chat</h3>  
							...
							<p>
                                                        Kies hier het chatprogramma (bijv. Skype).
                                                        </p>							

		...
		<div class="container wrap">
			<div class="inner">
				...
				<div id="icon-menu"></div>	
					<div id="logo">
							<a href="http://www.therapion.com/nl/" title="Welkom! Therapion.com - Psychologische hulp op internet.">
								Therapion
								<span></span>
							</a>
					</div>
...
<div id="main-menu" class="widget">
	<div class="container wrap">
		<div class="inner">			
			<div id="main-nav" >
				<ul>
					<li><a href="http://www.therapion.com/nl/">Home</a></li>
					<li><a href="http://www.therapion.com/nl/afspraak.php">Afspraak maken</a></li>
					<li><a href="http://www.therapion.com/nl/kosten-en-tarieven.php">Kosten en tarieven</a></li>
                                        <li><a href="http://www.therapion.com/nl/therapieprogramma.php">Therapieprogramma's</a></li>
					<li><a href="http://www.therapion.com/nl/vacatures.php">Vacatures</a></li>

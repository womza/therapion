		...
		<div class="container wrap">
			<div class="inner">
				...
				<div id="icon-menu"></div>	
					<div id="logo">
							<a href="http://www.therapion.local/nl/" title="Welkom bij Therapion Consulting. Therapion.com - Psychologische hulp op internet.">
								Therapion
								<span></span>
							</a>
					</div>
...
<div id="main-menu" class="widget">
	<div class="container wrap">
		<div class="inner">			
			<div id="main-nav" >
				<ul>
					<li><a href="http://www.therapion.local/nl/">Home</a></li>
					<li><a href="http://www.therapion.local/nl/afspraak.php">Afspraak maken</a></li>
					<li><a href="http://www.therapion.local/nl/kosten-en-tarieven.php">Kosten en tarieven</a></li>
					<li><a href="http://www.therapion.local/nl/vacatures.php">Vacatures</a></li>
					<li class="last"><a href="#">Taal kiezen</a>
						<div>
						<ul>
							<li  class="first">

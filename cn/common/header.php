		...
		<div class="container wrap">
			<div class="inner">
				...
				<div id="icon-menu"></div>	
					<div id="logo">
			<a href="http://www.therapion.local/cn/" title="歡迎來到 Therapion Consulting - 中国 | Therapion.com - 本網站為你提供專業的網上心理健康服務">
								Therapion
								<span></span>
							</a>
					</div>
...
<div id="main-menu" class="widget">
	<div class="container wrap">
		<div class="inner">			
			<div id="main-nav" >
				<ul>
					<li><a href="http://www.therapion.local/cn/">首頁</a></li>
					<li><a href="http://www.therapion.local/cn/china-appointments.php">預約</a></li>
					<li><a href="http://www.therapion.local/cn/china-fees.php">費用</a></li>
                                        <li><a href="http://www.therapion.local/cn/cnformcustomerservice.php">職位空缺</a></li>
                                        <li><a href="http://www.therapion.local/cn/china-vacancies.php">我們的服務</a></li>
                                       	<li class="last"><a href="#">選擇語言</a>
						<div>
						<ul>
							<li  class="first">

...
<head>
	...
	?>
		<title>Consultation par vidéoconférence</title> 
				...
				<div class="full-column">
					<div class="info">
						...
						<form method="POST" action="./sendvideoconference.php?id_psicologo=<?php echo $psicologo['id_psicologo'] ?>">
							...
							<h3>Consultation par vidéoconférence</h3>     
							...
							<h3>
							2. Programme de vidéoconférence 
							</h3>

							<p>
                                                        Vous pouvez choisir le programme de vidéoconférence (Skype, par example).
                                                        </p>
							...
							3. Votre séance
                                                        ...
                                                        <br />
                                                        La psychologue confirmera votre session dès que vous aurez effectué le paiement.
                                                        </p>

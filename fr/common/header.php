		...
		<div class="container wrap">
			<div class="inner">
				...
				<div id="icon-menu"></div>	
					<div id="logo">
							<a href="./" title="Bienvenue sur la page de Therapion Consulting. Therapion.com - Services de consultation psychologique en ligne.">
								Therapion
								<span></span>
							</a>
					</div>
		...
		<div class="inner">			
			<div id="main-nav" >
				<ul>
					...
					<li><a href="./tarifs.php">Horaires et tarifs</a></li>
					<li><a href="./emploi.php">Offres d'emploi</a></li>

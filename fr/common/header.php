		...
		<div class="container wrap">
			<div class="inner">
				...
				<div id="icon-menu"></div>	
					<div id="logo">
							<a href="http://www.therapion.local/fr/" title="Bienvenue sur la page de Therapion Consulting. Therapion.com - Services de consultation psychologique en ligne.">
								Therapion
								<span></span>
							</a>
					</div>
...
<div id="main-menu" class="widget">
	<div class="container wrap">
		<div class="inner">			
			<div id="main-nav" >
				<ul>
					<li><a href="http://www.therapion.local/fr/">Accueil</a></li>
					<li><a href="http://www.therapion.local/fr/consultation.php">Consultation</a></li>
					<li><a href="http://www.therapion.local/fr/nos-services.php">Nos services</a></li>
					<li><a href="http://www.therapion.local/fr/tarifs.php">Horaires et tarifs</a></li>
					<li><a href="http://www.therapion.local/fr/emploi.php">Offres d'emploi</a></li>
					<li class="last"><a href="#">Changez la langue</a>
						<div>
						<ul>
							<li  class="first">
								<a href="http://www.therapion.local"> 
									<img src="../assets/images/flag_en.gif" width="15" height="10" align="bottom" vspace="6" hspace="1" border="0" title="English"> 
									English
								</a>  
							</li>
							<li>
								<a href="http://www.therapion.local/es"> 
									<img src="../assets/images/flag_es.gif" width="15" height="10" align="bottom" vspace="6" hspace="1" border="0" title="Español"> 
									Español
								</a>  
							</li>
							<li>
								<a href="http://www.therapion.local/pt"> 

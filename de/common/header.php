		...
		<div class="container wrap">
			<div class="inner">
				...
				<div id="icon-menu"></div>	
					<div id="logo">
							<a href="http://www.therapion.local/de/" title="Psychologen Online. Therapion.com - Psychologische Hilfe und Psychotherapie über das Internet.">
								Therapion
								<span></span>
							</a>
					</div>
...
<div id="main-menu" class="widget">
	<div class="container wrap">
		<div class="inner">			
			<div id="main-nav" >
				<ul>
					<li><a href="http://www.therapion.local/de/">Startseite</a></li>
					<li><a href="http://www.therapion.local/de/termine.php">Termin buchen</a></li>
					<li><a href="http://www.therapion.local/de/kosten.php">Kosten</a></li>
					<li><a href="http://www.therapion.local/de/angebot.php">Unser Angebot</a></li>
					<li><a href="http://www.therapion.local/de/stellenangebote.php">Stellenangebote</a></li>
					<li class="last"><a href="#">Sprache wählen</a>
						<div>
						<ul>
							<li  class="first">

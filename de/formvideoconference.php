...
<head>
	...
	?>
		<title>Beratung per Videokonferenz</title> 
			...
			<div class="inner">	
				...
				<div class="full-column">
					...
					<form method="POST" action="./sendvideoconference.php?id_psicologo=<?php echo $psicologo['id_psicologo'] ?>"> 
						...
						<h3>Beratung per Videokonferenz</h3>     
							...
							<h3>
							2. Videokonferenz-Programm 
							</h3>

							<p>
                                                        Wählen Sie hier bitte Ihr Videokonferenz-Programm aus (z.B. Skype).
                                                        </p>
							
							<div class="control-group">
								<label class="control-label">Videokonferenz-Programm</label>
								<div class="controls">							

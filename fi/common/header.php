		...
		<div class="container wrap">
			<div class="inner">
				...
				<div id="icon-menu"></div>	
					<div id="logo">
							<a href="http://www.therapion.local/fi/" title="Tervetuloa, Therapion Consulting palvelee. Therapion.com - psykologit ja psykoterapeutit netissä.">
								Therapion
								<span></span>
							</a>
					</div>
...
<div id="main-menu" class="widget">
	<div class="container wrap">
		<div class="inner">			
			<div id="main-nav" >
				<ul>
					<li><a href="http://www.therapion.local/fi/">Etusivu</a></li>
					<li><a href="http://www.therapion.local/fi/ajanvaraus.php">Ajanvaraus</a></li>
					<li><a href="http://www.therapion.local/fi/palvelut.php">Palvelut</a></li>
					<li><a href="http://www.therapion.local/fi/hinnasto.php">Hinnasto</a></li>
					<li><a href="http://www.therapion.local/fi/yritys.php">Työpaikat</a></li>
					<li class="last"><a href="#">Valitse kieli</a>
					 <div>
						<ul>
							<li  class="first">

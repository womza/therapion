		...
		<div class="container wrap">
			<div class="inner">
				...
				<div id="icon-menu"></div>	
					<div id="logo">
							<a href="./" title="Tervetuloa, Therapion Consulting palvelee. Therapion.com - psykologit ja psykoterapeutit netissä.">
								Therapion
								<span></span>
							</a>
					</div>
		...
		<div class="inner">			
			<div id="main-nav" >
				<ul>
					...
					<li><a href="./ajanvaraus.php">Ajanvaraus</a></li>
					<li><a href="./palvelut.php">Palvelut</a></li>
					<li><a href="./hinnasto.php">Hinnasto</a></li>
					<li><a href="./yritys.php">Työpaikat</a></li>

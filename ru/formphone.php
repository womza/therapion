...
<head>
	...
	?>
	<title>Консультация по телефону </title> 
				...
				<div class="full-column">
					<div class="info">
						...
						<h3>Консультация по телефону</h3>     
							...
							<p>	
                                Мы можем позвонить Вам на стационарный телефон наземной сети или на мобильный телефон.
                                                       <br />
                                Если Вы живете за границей, пожалуйста начните с кода страны. 
                                                        <p>
							
							<div class="control-group">
							<label class="control-label">Ваш телефонный номер</label>
								<div class="controls">							

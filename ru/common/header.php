		...
		<div class="container wrap">
			<div class="inner">
				...
				<div id="icon-menu"></div>	
					<div id="logo">
							<a href="http://104.131.79.230/ru/" title="Добро пожаловать в Therapion Consulting. Therapion.com - Психологическая помощь онлайн.">
								Therapion
								<span></span>
							</a>
					</div>
...
<div id="main-menu" class="widget">
	<div class="container wrap">
		<div class="inner">			
			<div id="main-nav" >
				<ul>
					<li><a href="http://104.131.79.230/ru/">Главная</a></li>
                                        <li><a href="http://104.131.79.230/ru/konsultacija.php">Консультация</a></li>
					<li><a href="http://104.131.79.230/ru/uslugi.php">Услуги</a></li>
					<li><a href="http://104.131.79.230/ru/ceni.php">Цены</a></li>
					<li><a href="http://104.131.79.230/ru/rabota.php">Работа</a></li>
					<li class="last"><a href="#">Язык</a>
						<div>
						<ul>
							<li  class="first">

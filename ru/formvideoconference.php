...
<head>
	...
	?>
	<title>Консультация с помощью видео конференции</title> 
				...
				<div class="full-column">
					<div class="info">
						...
						<form method="POST" action="./sendvideoconference.php?id_psicologo=<?php echo $psicologo['id_psicologo'] ?>">
							...
							<h3>Консультация с помощью видео конференции</h3>     
...
Хорошие альтернативы: Skype, Facebook, VSee, и так далее. 					
						...
						<label class="control-label">Ваше предложение по времени и дате</label>
								<div class="controls">							
								<textarea rows="4" name="question" cols="63"></textarea> 	 		               <span>Если Вы живете за границей, пожалуйста укажите где так, чтобы мы знали правильный часовой пояс.</span>
								</div>
							</div>
